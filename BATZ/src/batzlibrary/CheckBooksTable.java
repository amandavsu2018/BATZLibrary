...
public class CheckBooksTable {
	...
	public ResultSet getCheckbookAvailable(String isbn, String tablenm, String tableid, String tableisbn, String tablepin){
		ResultSet check = null;
		String query = "SELECT " + tableid + " FROM " + tablenm + " WHERE " + tableisbn + " = '"
				+ isbn + "' AND " + tablepin + " IS NULL";
